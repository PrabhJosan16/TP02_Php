...
<ul>
    ...
    <li>On y retrouve un lien pour ajoyer un nouvel meal :</li>
    <ul>
    ...
    <ul>
        ...
        <li>On peut supprimer un plat après confirmation.</li>
...
<table>
    <tr>
        <td>
            ...
            <object data="Contenu/images/model_utiliser.png" type="image/svg+xml" height="500" width="800">
